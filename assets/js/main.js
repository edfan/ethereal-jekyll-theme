...
(function($) {
    ...
    $(function() {
        ...
        $('.gallery')
            ...
            .prepend('<div class="modal" tabIndex="-1"><div class="inner"><h1 class="modalName"></h1><img src="" /><p class="modalDescription"></p><a class="modalURL" target="_blank">Find out more</a></div></div>')
            .find('img')
